            ...
            for (String type : this.type.split(";")) {
                ...
                switch (Integer.parseInt(type)) {
                    ...
                    case 8://D�sapprendre un sort � un percepteur.
                        ...
                        if (player0.getFight() != null || guild == null || player0.getGuildMember() == null) return;
                        ...
                        if (obj != null) {
                            ...
                            if (spell != 0) {
                                ...
                                isOk = true;
                                send = true;
                                Database.getStatics().getGuildData().update(guild);
                    ...
                    case 21://Poser un objet d'�levage.
                        ...
                        id0 = object.getTemplate().getId();

                        int resist = object.getResistance(object.parseStatsString());
                        int resistMax = object.getResistanceMax(object.getTemplate().getStrTemplate());
