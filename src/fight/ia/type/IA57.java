 ...
 */
public class IA57 extends AbstractNeedSpell {

    public IA57(Fight fight, Fighter fighter, byte count) {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            Fighter A = Function.getInstance().getNearestAminbrcasemax(this.fight, this.fighter, 1, maxPo + 1);// pomax +1;
