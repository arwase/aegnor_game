 ...
 */
public class IA63 extends AbstractNeedSpell {

    public IA63(Fight fight, Fighter fighter, byte count) {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            if (this.fighter.getCurPa(this.fight) > 0 && !action) {
                if (Function.getInstance().invocIfPossible(fight, this.fighter, this.invocations)) {
                    time = 1000;
                    action = true;
                }
            }
